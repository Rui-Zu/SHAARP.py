...
|---|---|---|
| Windows (64-bit) | [`SHAARP_py_v1.0.0_win64.zip`](https://github.com/Rui-Zu/SHAARP.py/releases/download/v1.0.0/SHAARP_py_v1.0.0_win64.zip) (about 115 MB) | extract, then double-click `SHAARP_py\SHAARP_py.exe` |
| macOS, Apple Silicon (M-series) | [`SHAARP_py_v1.0.0_macos_arm64.zip`](https://github.com/Rui-Zu/SHAARP.py/releases/download/v1.0.0/SHAARP_py_v1.0.0_macos_arm64.zip) (about 79 MB) | extract, then open `SHAARP_py/SHAARP_py.app` |
