...
``build/bundle_benchmarks/``; the build entry point (``build_desktop_exe.bat`` ->
``scripts/build_gui_bundle.py``) points ``--add-data`` at the staged tree, and the release gate's
