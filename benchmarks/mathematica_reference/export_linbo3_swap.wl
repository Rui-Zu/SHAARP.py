...
MakerInputPath = SHAARPPaths`Ref["linbo3_swap_input.json"];
MakerOutputPath = SHAARPPaths`Ref["linbo3_swap_reference.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["linbo3_swap_diag.txt"];
EndPackage[];
