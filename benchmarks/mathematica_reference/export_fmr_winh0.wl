...
MakerInputPath = SHAARPPaths`Ref["fmr_winh0_input.json"];
MakerOutputPath = SHAARPPaths`Ref["fmr_winh0_reference.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["fmr_winh0_diag.txt"];
EndPackage[];
