...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_neg_mid_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_neg_mid_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_neg_mid_diagnostics.txt"];
EndPackage[];
