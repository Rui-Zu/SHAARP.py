...
Export[
  SHAARPPaths`Ref["solve_fresnel_definition.json"],
  <|
    "source" -> "Mathematica SHAARP.ml setup.nb solveFresnel definition",
    "wolfram_version" -> $Version,
    "inputCellCount" -> SHAARPReferenceLoader`inputCellCount,
    "downValueCount" -> Length[DownValues[solveFresnel]],
    "definition" -> ToString[DownValues[solveFresnel], InputForm],
    "definitionN" -> ToString[DownValues[solveFresnelN], InputForm]
  |>,
  "JSON"
];
Quit[]
