...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_fringe_center_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_fringe_center_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_fringe_center_reference_diagnostics.txt"];
EndPackage[];
