...
MakerInputPath = SHAARPPaths`Ref["maker_fine_mathematica_inputs_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_reference_diagnostics.txt"];
EndPackage[];
