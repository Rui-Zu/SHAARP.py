...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_high_oblique_lowmid_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_high_oblique_lowmid_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_high_oblique_lowmid_diagnostics.txt"];
EndPackage[];
