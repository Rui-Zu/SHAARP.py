...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_fringe_pos_tail_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_fringe_pos_tail_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_fringe_pos_tail_diagnostics.txt"];
EndPackage[];
