...
MakerInputPath = SHAARPPaths`Ref["fmr_winh1_input.json"];
MakerOutputPath = SHAARPPaths`Ref["fmr_winh1_reference.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["fmr_winh1_diag.txt"];
EndPackage[];
