...
MakerInputPath = SHAARPPaths`Ref["maker_0p1_pilot_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_0p1_pilot_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_0p1_pilot_diagnostics.txt"];
EndPackage[];
