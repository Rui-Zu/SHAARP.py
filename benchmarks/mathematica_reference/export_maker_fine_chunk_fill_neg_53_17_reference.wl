...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_fill_neg_53_17_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_fill_neg_53_17_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_fill_neg_53_17_diagnostics.txt"];
EndPackage[];
