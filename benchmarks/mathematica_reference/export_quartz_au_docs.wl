...
MakerInputPath = SHAARPPaths`Ref["quartz_au_docs_input.json"];
MakerOutputPath = SHAARPPaths`Ref["quartz_au_docs_reference.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["quartz_au_docs_diag.txt"];
EndPackage[];
