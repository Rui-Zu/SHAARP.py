...
outputPath = SHAARPPaths`Ref["maker_high_oblique_80_solvefresneln_system_v1.json"];
...
solveFresnelNSystemSnapshot[wAir_, wMed_, wSub_, thickness_, unknowns_] := Module[
  {equ = {}, equTop, equBot, equE, equH, nM, i, getH, B, M, sol, coeffs,
   residualPlus, residualMinus, singVals},
  nM = Length[wMed];
...
Export[
  outputPath,
  <|
    "source" -> "Mathematica SHAARP.ml setup.nb solveFresnelN system captured inside f4L for fine Maker high-oblique theta=80",
    "status" -> "mathematica_maker_high_oblique_solvefresneln_system_exported",
