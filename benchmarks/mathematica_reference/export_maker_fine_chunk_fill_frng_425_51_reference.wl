...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_fill_frng_425_51_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_fill_frng_425_51_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_fill_frng_425_51_diagnostics.txt"];
EndPackage[];
