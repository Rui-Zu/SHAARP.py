...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_fill_hob_85_35_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_fill_hob_85_35_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_fill_hob_85_35_diagnostics.txt"];
EndPackage[];
