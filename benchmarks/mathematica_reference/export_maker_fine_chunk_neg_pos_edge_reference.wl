...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_neg_pos_edge_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_neg_pos_edge_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_neg_pos_edge_diagnostics.txt"];
EndPackage[];
