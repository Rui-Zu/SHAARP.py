...
(* Drive the existing Maker-fringe exporter against the ml8 MULTILAYER manifest
   (9-layer stacks: air / active-film / anisotropic-interlayer / isotropic-
   interlayer / isotropic-interlayer-2 / isotropic-interlayer-3 / anisotropic-
   interlayer-2 / isotropic-interlayer-4 / substrate) by setting
...
SHAARPPathOverrides`MakerInputPath = SHAARPPaths`Ref["maker_mathematica_inputs_ml8.json"];
SHAARPPathOverrides`MakerOutputPath = SHAARPPaths`Ref["maker_fringes_reference_ml8.json"];
SHAARPPathOverrides`MakerDiagnosticPath = SHAARPPaths`Ref["maker_fringes_reference_ml8_diagnostics.txt"];
