...
MakerInputPath = SHAARPPaths`Ref["fmr_winh2_input.json"];
MakerOutputPath = SHAARPPaths`Ref["fmr_winh2_reference.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["fmr_winh2_diag.txt"];
EndPackage[];
