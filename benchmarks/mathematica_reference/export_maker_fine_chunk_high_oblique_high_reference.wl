...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_high_oblique_high_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_high_oblique_high_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_high_oblique_high_diagnostics.txt"];
EndPackage[];
