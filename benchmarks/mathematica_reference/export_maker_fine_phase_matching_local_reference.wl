...
MakerInputPath = SHAARPPaths`Ref["maker_fine_phase_matching_local_mathematica_inputs_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_phase_matching_local_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_phase_matching_local_reference_diagnostics.txt"];
EndPackage[];
