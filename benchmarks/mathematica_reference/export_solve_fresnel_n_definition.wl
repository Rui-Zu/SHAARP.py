...
Export[
  SHAARPPaths`Ref["solve_fresnel_n_definition.json"],
  <|
    "source" -> "Mathematica SHAARP.ml setup.nb solveFresnelN definition",
    "status" -> "mathematica_definition_exported",
    "wolfram_version" -> $Version,
    "inputCellCount" -> SHAARPReferenceLoader`inputCellCount,
    "definition" -> ToString[DownValues[solveFresnelN], InputForm]
  |>,
  "JSON"
];
Quit[]
