...
(* pg3: '4'/'6' point-group d-pattern end-to-end. Uses the manifest's explicit
   constrained d_voigt_crystal; pg string only sets the nonlinear flag. ORIGINAL paths. *)
SHAARPPathOverrides`MakerInputPath = SHAARPPaths`Ref["maker_mathematica_inputs_pg3.json"];
SHAARPPathOverrides`MakerOutputPath = SHAARPPaths`Ref["maker_fringes_reference_pg3.json"];
SHAARPPathOverrides`MakerDiagnosticPath = SHAARPPaths`Ref["maker_fringes_reference_pg3_diagnostics.txt"];
