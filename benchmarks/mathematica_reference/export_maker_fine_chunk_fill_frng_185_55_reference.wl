...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_fill_frng_185_55_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_fill_frng_185_55_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_fill_frng_185_55_diagnostics.txt"];
EndPackage[];
