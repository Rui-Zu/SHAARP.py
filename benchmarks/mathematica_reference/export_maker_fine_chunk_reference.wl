...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_reference_diagnostics.txt"];
EndPackage[];
