...
MakerInputPath = SHAARPPaths`Ref["maker_fine_chunk_fringe_pos_mid_input_v1.json"];
MakerOutputPath = SHAARPPaths`Ref["maker_fine_chunk_fringe_pos_mid_reference_v1.json"];
MakerDiagnosticPath = SHAARPPaths`Ref["maker_fine_chunk_fringe_pos_mid_diagnostics.txt"];
EndPackage[];
